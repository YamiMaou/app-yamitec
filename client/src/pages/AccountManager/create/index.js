...
const TextInputsAutocomplete = (props) => {
    ...
    return (<div>
        <TextField value={value} helperText={props.helperText ?? ""} key={`input-${15000}`} id={"cpf_cnpj"} label={props.label} name={"cpf_cnpj"} style={{margin: "20px 5px 5px",flexBasis: window.innerWidth < 768 ? '100%' : props.flexBasis }} onChange={handleChange} />
