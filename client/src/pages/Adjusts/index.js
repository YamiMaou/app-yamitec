...
class Adjusts extends Component {
    state = {
    ...
    render() {
        ...
        const  modulesId = [
            {id: 0, name: 'Colaboradores'},
            {id: 1, name: 'Clientes'},
            {id: 2, name: 'Responsáveis'},
            
        ];
        const rows : RowsProp = [
            {id: 1, module: 'Colaboradores', }
        ];
...
export default connect(mapStateToProps, mapDispatchToProps)(Adjusts)
